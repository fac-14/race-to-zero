...
const getBoughtItems = userId =>
  new Promise((resolve, reject) => {
    db.query(
      `SELECT * FROM inventory INNER JOIN inventory_status ON inventory_status.inventory_id = inventory.id WHERE inventory_status.bought is true AND inventory_status.user_id = $1;`,
      [userId]
    )
