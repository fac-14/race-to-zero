...
VALUES
    ...
    (NULL, 'Farmers Market', 'Locate a farmers market near you and plan a family trip to visit. Look at all of the beautiful and seasonal produce. Chat with the farmers about how the food is grown. If youre feeling extra adventurous purchase a new or beautiful looking fruit or vegetable and learn to make a new meal!', 'Food can travel a long way before it gets to your plate, and sometimes you dont know how it was grown. At the farmers market, you know your food is local and you can ask the farmer how it was grown. How neat is that!?', 'https://www.lfm.org.uk/markets-home/', '../../public/imgs/challenge-icons/farmer.svg', 10, true),
